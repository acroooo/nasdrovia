    ...
    return (  
        <div className='total'>
             <div className='container general'>
                 ...
                 <TitulosCategorias/>
                 <ListaCategorias  setSolicitud={setSolicitud} accion={setAccionCategorias} categorias={listadoCategorias} editar={setCategoriaEditar}/>
                 <SubformularioCategorias n={nextId} catCrear={categoriaCrear} catEditar={categoriaEditar} setSolicitud={setSolicitud} 
                 accion={accionCategorias} setAccion={setAccionCategorias} editar={setCategoriaEditar} crear={setCategoriaCrear}/>
             </div>
         </div>
    );
}
