...
export default function Icons() {
    ...
    return (
        ...
        <div className="contenedor-login">
            {logueado ?  <i className="fas fa-user login-user"></i>:<i className="fas fa-user-circle login-user"  onClick={()=>{setFormulario('activo');setTipo('registrar')}}></i>}
            <small>{usuario}</small>
        </div>

       
          <div className="admin" id='a'>
               {logueado && <i className="fas fa-tools" onClick={()=>document.getElementById('panel').classList.toggle('mostrar')}></i>}
