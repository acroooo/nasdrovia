            ...
            <div className="modal opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center">
                ...
                <div className="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
                    ...
                    <div className="modal-close absolute top-0 right-0 cursor-pointer flex flex-col items-center mt-4 mr-4 text-white text-sm z-50">
                        <svg className="fill-current text-white" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" onClick={toggleModal}>
                    ...
                    <div className="modal-content py-4 text-left px-6">
                        ...
                        <div className="flex justify-between items-center pb-3">
                            ...
                            <div className="modal-close cursor-pointer z-50">
                                <svg className="fill-current text-black" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" onClick={toggleModal}>
                                    <path d="M14.53 4.53l-1.06-1.06L9 7.94 4.53 3.47 3.47 4.53 7.94 9l-4.47 4.47 1.06 1.06L9 10.06l4.47 4.47 1.06-1.06L10.06 9z"></path>
                                </svg>
                            </div>
                        </div>
                        ...
                        <form className="grid grid-cols-12">
                            ...
                            <input name='id' className="col-span-12 border mx-4 px-2 py-1" type="text" id='id' onChange={handleChange}/>
                            <label className="col-span-12 mb-1 mx-4">Nombre</label>
                            <input name='nombre' className="col-span-12 border mx-4 px-2 py-1" type="text" id='nombre' onChange={handleChange}/>
                            <label className="col-span-12 mb-1 mx-4">Descripción</label>
                            <input name='descripcion' className="col-span-12 border mx-4 px-2 py-1" type="text" id='descripcion' onChange={handleChange} />
                            <label className="col-span-12 mb-1 mx-4">Imagen</label>
                            <input name='imagen' className="col-span-12 border mx-4 px-2 py-1" type="text" id='imagen' onChange={handleChange}/>
                            <label className="col-span-12 mb-1 mx-4">Stock</label>
                            <input name='stock' className="col-span-12 border mx-4 px-2 py-1" type="text" id='stock'  onChange={handleChange}/>
                            <label className="col-span-12 mb-1 mx-4">Precio</label>
                            <input name='precio' className="col-span-12 border mx-4 px-2 py-1" type="text" id='precio' onChange={handleChange} />
                        </form>
