...
const Producto = ({nombre, descripcion, precio, cantidad}) => {
  ...
  const props = {
    ...
    descripcion: "Linea Starke, cerveza de tonos rubios, sabores intensos, lista y fresca para disparar el lupulo de su cepa. Desde los alpes alemanes a la puerta de tu casa.",
    precio: "$59",
    cantidad: [1,6,12,24]
  }
  return (
